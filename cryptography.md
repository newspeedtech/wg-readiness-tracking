...
| PyCa/cryptography |	>=47.0.0 |	🟢 Ready | Python | ML-KEM, ML-DSA | Initial support in [47.0.0](https://cryptography.io/en/latest/changelog/#v47-0-0) only when compiled against AWS-LC or BoringSSL. Support when built against OpenSSL and in their official PyPI wheels [only >=48.0.0](https://cryptography.io/en/latest/changelog/#v48-0-0) |
